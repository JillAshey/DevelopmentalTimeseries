...
test <- annot %>%
  ...
  dplyr::filter(V1 == "Montipora_capitata_HIv3___Scaffold_8_565039") #%>%
...
ggsave("../output/Molecular/miRNA_mRNA_interactions/GO_en_sig_miRNA_targets_network_Montipora_capitata_HIv3___Scaffold_8_565039.png", plot = network_plot, height = 20, width = 15)
```

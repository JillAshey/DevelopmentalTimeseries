...
network_plot <- ggraph(g_tbl, layout = "fr") +
  ...
  geom_node_text(aes(label = name), repel = TRUE, size = 3, family = "Helvetica") + # Specify font here
  scale_edge_width(range = c(0.5, 3)) +
  scale_color_manual(values = c("miRNA" = "lightblue", "mRNA" = "lightgreen", 
                                 "Positive correlation" = "blue", 
                                 "Negative correlation" = "red")) +
  theme_graph();network_plot 

#ggsave("../output/Molecular/miRNA_mRNA_interactions/GO_en_sig_miRNA_targets_network.pdf", plot = network_plot, height = 49, width = 40)
ggsave("../output/Molecular/miRNA_mRNA_interactions/GO_en_sig_miRNA_targets_network_preferrednames_cluster_example.png", plot = network_plot, height = 30, width = 25)
```
